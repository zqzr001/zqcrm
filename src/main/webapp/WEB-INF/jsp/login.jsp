...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo.png" alt="hzcms Admin" style="height:40px;"></a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
		...
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.hzmux.hzcms.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
        <div id="login-wraper">
            <form id="loginForm"  class="form login-form" action="/doLogin" method="post">
                ...
                <div class="body">
					...
					<div class="control-group">
						<div class="controls">
							<input type="password" id="password" name="userPwd" class="required" placeholder="密码"/>
						</div>
					</div>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://github.com/Hzmux/hzcms" target="_blank">hzcms</a> ${fns:getConfig('version')}
    </footer>
  </body>
</html>