...
<body>
	...
	<form id="inputForm" action="/lend/addLend" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="lMoney" type="text" class="lbl"></input>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="lRate" type="text" class="lbl"></input>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">收益方式:</label>
			<div class="controls">
				<input name="lType" type="text" class="lbl"></input>
			</div>
		</div>
